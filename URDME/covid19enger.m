function umod = covid19enger
%COVID19ENGER Scenario model file for the EngEr Covid-19 model.
...
r{5} = 'A > gammaA*F1*A > I';
r{6} = 'I > gammaI*F2*I > H';
r{7} = 'I > gammaI*F2d*I > D';
r{8} = 'I > gammaI*(1-F2-F2d)*I > R';
r{9} = 'H > gammaH*F3*H > W';
r{10} = 'H > gammaH*F3d*H > D';
r{11} = 'H > gammaH*(1-F3-F3d)*H > R';
r{12} = 'W > gammaW*F4*W > D';
r{13} = 'W > gammaW*(1-F4)*W > H';
