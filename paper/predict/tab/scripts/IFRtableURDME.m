...
for k = URDME_k
    ...
    for rid = reg
        ...
        for j = 1:numel(intervals)
            ...
            intervals_quantiles = cat(1, intervals_quantiles, [rid quant*100, intervals{j}]);
        end
    end
...
function tex = l_texify(TAB, asterix, dagger, TOL_iqr)
    ...
    tex = [tex newline ...
           ...
           '{\scriptsize \footnotemark[4] The estimated bias is large compared' newline ...
           'to the 68\% CrI (see \matmet).}\\' newline ...
           '{\scriptsize \footnotemark[3] The 68\% CrIs of the posterior and the bootstrap' newline ...
